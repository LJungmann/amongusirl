...
Start
![Lights_Out_Start_State](https://github.com/user-attachments/assets/a69647af-ab84-43dd-9b8b-de770732151d)
Goal
![Lights_Out_Goal](https://github.com/user-attachments/assets/a72b5ef6-ae5a-418b-9bc2-0b1087a8b852)
...
![Wires_Station](https://github.com/user-attachments/assets/5d3db0f8-9d92-4548-ab5b-a04d4d267ceb)
![Wires_Task_Explanation](https://github.com/user-attachments/assets/eaaa02df-6458-4687-985c-d3778025bbed)
...
![Simon_Says_Station](https://github.com/user-attachments/assets/3d3b0f7c-eebf-415c-8976-75f46eeb98c8)
![Simon_Says_Gameplay](https://github.com/user-attachments/assets/99dd63d3-a5b0-43ac-939b-3955d2298764)
...
To begin, players start in the Lobby. Here players have the option to host a new lobby or join an existing one. The data for this (and everything else), is queried from the backend on a 1s interval. Future improvements could include event based communications via Webhooks or WebRTC.  
...
After the host clicks the start button, all players are moved to the game screen. Here they see the task progress and scan player progress. Currently, every player needs to complete 3 tasks and a total of *player count squared* players need to be scanned. This is still up for change, as there are some balancing issues, like e.g. Imposters also need to complete all their tasks for the crewmates to win.  
...
The top level component of the game is the *App*. Here, the game decides, if it should show the *Lobby* or the *Game*, or an info that the game is already running, or during development, the *Debug* UI.   
...
![Code_Structure2](https://github.com/user-attachments/assets/24ae2ecf-9588-4f57-bdc5-bd8e7e6f8ad2)
...
![Code_Structure3](https://github.com/user-attachments/assets/80a2363f-506d-43be-87bc-592852944601)

![Code_Meeting](https://github.com/user-attachments/assets/c5de4e1b-1d31-4607-8128-e29ba526376c)
...
![Code_Meeting2](https://github.com/user-attachments/assets/dcc60821-d649-4f38-8861-35296ca86dfc)
...
For every game, the same procedure has to be done, we created devices with those device\_ids:
...
On ‘message’ received: We parse the payload and look for the device\_id and the received data in the text field. By that we can do different things based on the device\_id that we get from TTN.   
